function characterization_benchmark(charac_n,charac_r,r_list,UCB2D,r_bench, n_bench)
...
hold on; plot(n_list, charac_n, '-.', 'Color', 'k', 'LineWidth', 1);
xlim([1 15])
...
hold on; plot(r_list, charac_r, '-.', 'Color', 'k', 'LineWidth', 1);
